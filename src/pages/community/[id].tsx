  ...
  return (
    <Layout canGoBack>
      <div>
        ...
        <div>
          ...
          <div className="flex px-4 space-x-5 mt-3 text-gray-700 py-2.5 border-t border-b-[2px]  w-full">
            <button
              ...
              className={cls('flex space-x-2 items-center text-sm', post_data.data?.isWondering ? 'text-teal-400' : '')}
            >
              <svg
                className="w-4 h-4"
                fill="none"
        ...
        <form className="px-4" onSubmit={handleSubmit((data) => onCreateAnswer(router.query.id as string, data))}>
          <TextArea
            name="description"
