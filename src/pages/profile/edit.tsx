    ...
    <Layout canGoBack title="Edit Profile">
      <form onSubmit={handleSubmit(onUpdateUser)} className="py-10 px-4 space-y-4">
        <div className="flex items-center space-x-3">
          {avatar_priveiw ? (
            <Image
              src={`https://imagedelivery.net/PvvqDlv-2VYHUsYbyy-DlQ/${avatar_priveiw}/avatar`}
        ...
        <Input register={register('name', { required: true })} required={false} label="Name" name="name" type="text" />
        <Input
